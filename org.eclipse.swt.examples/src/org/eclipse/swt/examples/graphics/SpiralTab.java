...
public class SpiralTab extends AnimatedGraphicsTab {
	...
	/**
	 * This method creates a spinner for specifying the number of petals. The call to the createControlPanel method in
	 * the super class create the controls that are defined in the super class.
	 * 
	 * @param parent
