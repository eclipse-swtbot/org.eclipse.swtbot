...
/**
 * This tab shows the effects of applying various interpolation algorithms to images that have been stretched or shrunk.
 */
public class InterpolationTab extends GraphicsTab {
	...
	public void paint(GC gc, int width, int height) {
		...
		Font font = new Font(device, InterpolationTab.getPlatformFont(), 20, SWT.NORMAL);
		gc.setFont(font);
