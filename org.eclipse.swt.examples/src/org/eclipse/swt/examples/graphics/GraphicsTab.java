...
/**
 * This class is the one used for creating a graphic. Override the paint() method to create the drawing. To create an
 * animated graphic, use the AnimatedGraphicsTab class.
 */
