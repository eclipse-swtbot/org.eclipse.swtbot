 ...
 * http://www.eclipse.org/downloads/download.php?file=/nattable/releases/1.4.0/NatTableExamples-1.4.0.jar
 * It is located at folder org\eclipse\nebula\widgets\nattable\examples\examples\_100_Layers
 *
 * Example showing a NatTable with Tree Layer.
 */
public class TreeGridExample {
	...
	private void runInUIThread() {
		...
		display.syncExec(new Runnable() {
			@Override
			public void run() {
				shell = createShell(display, "Nebula NatTable with Tree");
	...
	public Control createNatTable(final Shell shell) {
		...
		NatTable natTable = new NatTable(shell, gridLayer, false);
