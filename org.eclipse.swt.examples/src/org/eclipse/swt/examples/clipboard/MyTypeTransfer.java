...
public class MyTypeTransfer extends ByteArrayTransfer {
	...
	private static final int		MYTYPEID	= Transfer.registerType(MyTypeTransfer.MYTYPENAME);
	private static final String		MYTYPENAME	= "name_list";										//$NON-NLS-1$

	public static MyTypeTransfer getInstance() {
		return MyTypeTransfer._instance;
	}
	...
	protected int[] getTypeIds() {
		return new int[] { MyTypeTransfer.MYTYPEID };
	}

	protected String[] getTypeNames() {
		return new String[] { MyTypeTransfer.MYTYPENAME };
	}
