...
public class ContainerFigure extends Figure {
	 ...
	 *            the GC to draw on
	 * @param offset
	 *            the offset to add to virtual coordinates to get display coordinates
	 * @param rememberedState
	 *            the state returned by a previous drawPreview() or addAndPreview() using this Container, may be null if
	 *            there was no such previous call
