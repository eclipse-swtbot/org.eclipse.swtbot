...
/**
 * This tab demonstrates antialiasing for graphics. Antialiasing is used for smoothing jagged edges in graphics. This
 * tab allows the user to see the effects of different antialiasing values.
 */
