...
abstract class RangeTab extends Tab {
	...
	/**
	 * Create a group of widgets to control the maximum attribute of the example widget.
	 */
	...
	/**
	 * Create a group of widgets to control the minimum attribute of the example widget.
	 */
	...
	/**
	 * Create a group of widgets to control the selection attribute of the example widget.
	 */
