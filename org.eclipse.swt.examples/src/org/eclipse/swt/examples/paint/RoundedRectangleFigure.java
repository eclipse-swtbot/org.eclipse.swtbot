...
public class RoundedRectangleFigure extends Figure {
	...
	/**
	 * Constructs a Rectangle These objects are defined by any two diametrically opposing corners.
	 * 
	 * @param color
	 ...
	 */
	public RoundedRectangleFigure(Color foregroundColor, Color backgroundColor, int lineStyle, int x1, int y1, int x2,
			int y2, int diameter) {
