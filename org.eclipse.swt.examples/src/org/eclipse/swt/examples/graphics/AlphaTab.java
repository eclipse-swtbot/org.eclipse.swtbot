...
/**
 * This tab demonstrates alpha blending. It draws various shapes and images as alpha values change.
 */
public class AlphaTab extends AnimatedGraphicsTab {
	/**
	 * Creates a font using the specified arguments and returns it. This method takes into account the resident
	 * platform.
	 * 
	 * @param face
	...
	int		alphaValue;
	/**
	 * Value used in setAlpha API call. Goes from 0 to 255, then from 255 to 0 and then starts over.
	 */
	int		alphaValue2;
