...
public abstract class AnimatedGraphicsTab extends GraphicsTab {
	...
	/**
	 * Gets the animation time that is selected in the spinner. Animation time: number of milliseconds between the
	 * current drawing and the next (the time interval between calls to the next method). Should be overridden to return
	 * a value that is more appropriate for the tab.
	 */
	...
	/**
	 * Gets the initial animation time to be used by the tab. Animation time: number of milliseconds between the current
	 * drawing and the next (the time interval between calls to the next method). Should be overridden to return a value
	 * that is more appropriate for the tab.
	 */
