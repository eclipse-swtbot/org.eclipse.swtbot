 ...
 * information that is added to a <code>Table</code> widget or edits a <code>TableItem</code> entry to represent the
 * entered data.
 */
public class DataEntryDialog {
	...
	private void createControlButtons() {
		...
		okButton.setText(DataEntryDialog.resAddressBook.getString("OK"));
		...
		cancelButton.setText(DataEntryDialog.resAddressBook.getString("Cancel"));
