...
class ToolBarTab extends Tab {
	...
	void createExampleWidgets() {
		...
		/*
		 * Create the example widgets. A tool bar must consist of all image tool items or all text tool items but not
		 * both.
		 */
		...
		/*
		 * Do not add the selection event for this drop down tool item. Without hooking the event, the drop down widget
		 * does nothing special when the drop down area is selected.
		 */
	}
