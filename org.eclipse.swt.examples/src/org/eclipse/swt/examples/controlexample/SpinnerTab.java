...
class SpinnerTab extends RangeTab {
	...
	/**
	 * Create a group of widgets to control the digits attribute of the example widget.
	 */
	...
	/**
	 * Create a group of widgets to control the increment attribute of the example widget.
	 */
	...
	/**
	 * Create a group of widgets to control the page increment attribute of the example widget.
	 */
